...
public class ScreenOnlineGame extends Screen implements ActionListener{
	...
	/**
	 * Constructs a new ScreenOnlineGame
	 * 
	...
	private void drawGame() {
		...
		boardRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot arg0) {
            	BoardPost value = arg0.getValue(BoardPost.class);
...
//				board.play();
	...
	/**
	 * Sets the DatabaseReference to the board of this game to ref
	 * @param ref the DatabaseReference to the board of this game
	 */
	public void setBoardRef(DatabaseReference ref) {
		this.boardRef = ref;
	}
